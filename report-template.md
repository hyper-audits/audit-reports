...
A time-boxed security review of the **protocol name** protocol was done by **R-Nemes**, with a focus on the security aspects of the application's implementation.
